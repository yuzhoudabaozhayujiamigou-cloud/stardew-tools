        ...
        <article className="space-y-6">
          <header className="rounded-[30px] border-4 border-[#7c4d2e]/80 bg-[#f3e5bf]/95 p-6 shadow-[0_12px_30px_rgba(56,41,23,0.3)] ring-1 ring-yellow-900/20 sm:p-8">
            ...
            <div className="mt-5 rounded-2xl border border-[#7c4d2e]/30 bg-[#fff8e8] p-4 text-sm leading-6 text-[#5f4228]/90">
              ...
              <p className="mt-2">
                Blueberry is the safest Summer default because it survives imperfect timing, but it is not always the
                highest-value answer. Use Starfruit when you have cash and kegs, use Melon when you want a simpler
                premium lane, and avoid Hops unless you are ready for daily harvesting plus steady keg turnover.
              </p>
            </div>
          ...
          <section className={CARD}>
            ...
            <p className="mt-4 text-sm leading-6 text-[#5f4228]/90 sm:text-base">
              ...
              . Then test the shortlist in the{" "}
              <Link href="/calculator" className={LINK}>
                Stardew Valley crop calculator
              </Link>
              {" "}with your real Summer day count before buying seeds.
            </p>
          </section>
