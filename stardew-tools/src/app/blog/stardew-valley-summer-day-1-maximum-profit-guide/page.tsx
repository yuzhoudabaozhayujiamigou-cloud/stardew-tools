...
export default function StardewValleySummerDay1MaximumProfitGuidePage() {
  ...
  const articleLd = {
    ...
    const readNextPosts = getBlogReadNextPosts("stardew-valley-summer-day-1-maximum-profit-guide", 3);
      ...
      <main className="relative z-10 mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <Breadcrumb
          items={[
            { name: "Home", href: "/" },
            { name: "Blog", href: "/blog" },
            { name: "Stardew Valley: Summer Day 1 Maximum Profit Guide" },
          ]}
        />
...
<article className="space-y-6">
        ...
        <BlogReadNext posts={readNextPosts} currentSlug="stardew-valley-summer-day-1-maximum-profit-guide" />
