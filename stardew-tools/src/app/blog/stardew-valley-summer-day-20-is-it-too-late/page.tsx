      ...
      <main className="relative z-10 mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <Breadcrumb
          items={[
            { name: "Home", href: "/" },
            { name: "Blog", href: "/blog" },
            { name: "Stardew Valley: Summer Day 20 — Is It Too Late?" },
          ]}
        />
...
<article className="space-y-6">
          ...
          <section className="rounded-[28px] border-4 border-[#7c4d2e]/80 bg-[#f3e5bf]/95 p-5 shadow-[0_12px_28px_rgba(56,41,23,0.28)] ring-1 ring-yellow-900/20 sm:p-7">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-6 text-[#614326]/90">
              ...
              <li>
                For the final panic threshold: {" "}
                <Link className="font-semibold underline" href="/blog/stardew-valley-is-it-too-late-to-plant-on-summer-day-25">
                  Stardew Valley: Is It Too Late to Plant on Summer Day 25?
                </Link>
              </li>
              <li>
                Restart from full-season planning: {" "}
