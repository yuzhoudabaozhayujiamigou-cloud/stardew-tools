...
export default function SpringDay15WhatToPlantProfitPage() {
  ...
  const articleLd = {
    ...
    const readNextPosts = getBlogReadNextPosts("spring-day-15-what-to-plant-profit", 3);
      ...
      <main className="relative z-10 mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <Breadcrumb
          items={[
            { name: "Home", href: "/" },
            { name: "Blog", href: "/blog" },
            { name: "Spring Day 15: What To Plant for Profit (Stardew)" },
          ]}
        />
...
<article className="space-y-6">
          ...
          <section className="rounded-[28px] border-4 border-[#7c4d2e]/80 bg-[#f3e5bf]/95 p-5 shadow-[0_12px_28px_rgba(56,41,23,0.28)] ring-1 ring-yellow-900/20 sm:p-7">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-6 text-[#614326]/90">
              ...
              <li>
                For the emergency late threshold: {" "}
