...
const FALL_TOP_CROPS: RankedCrop[] = (cropsData as CropRecord[])
      ...
      <main className="relative z-10 mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
        <header className={CARD_CLASS}>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-[#5f4228]/90 sm:text-base">
            ...
            compares fall crops from our calculator dataset using a simple gold/day estimate.
          </p>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-[#5f4228]/90 sm:text-base">
        ...
        <section className={`mt-8 ${CARD_CLASS}`}>
          <h2 className="text-xl font-semibold text-[#4a321e] sm:text-2xl">Top Fall crops by gold/day estimate</h2>
